...
function j$1(e, t) {
	...
	return function() {
		...
		function a(n, o) {
			...
			r.p = Object.assign({ theme: f$1 && f$1() }, c), r.o = / *go\d+/.test(s), c.className = u$1.apply(r, l) + (s ? " " + s : ""), t && (c.ref = o);
			let i = e;
...
var K = (e, t) => {
	...
	let s = (0, import_react.useCallback)(() => {
		r && u({
			type: 6,
			time: Date.now()
		});
	}, [r]), a = (0, import_react.useCallback)((o, n) => {
...
`, M = ({ toast: e }) => {
	...
	return t !== void 0 ? typeof t == "string" ? import_react.createElement(Te, null, t) : t : r === "blank" ? null : import_react.createElement(le, null, import_react.createElement(V, { ...s }), r !== "loading" && import_react.createElement(ue, null, r === "error" ? import_react.createElement(k, { ...s }) : import_react.createElement(_, { ...s })));
};
var ye = (e) => `
...
`, Ae = (e, t) => {
...
}, C = import_react.memo(({ toast: e, position: t, style: r, children: s }) => {
	let a = e.height ? Ae(e.position || t || "top-center", e.visible) : { opacity: 0 }, o = import_react.createElement(M, { toast: e }), n = import_react.createElement(Se, { ...e.ariaProps }, f(e.message, e));
	return import_react.createElement(be, {
		...
		icon: o,
		message: n
	}) : import_react.createElement(import_react.Fragment, null, o, n));
});
m(import_react.createElement);
var ve = ({ id: e, className: t, style: r, onHeightUpdate: s, children: a }) => {
	let o = import_react.useCallback((n) => {
		if (n) {
			let i = () => {
...
`, R = 16, Oe = ({ reverseOrder: e, position: t = "top-center", toastOptions: r, gutter: s, children: a, containerStyle: o, containerClassName: n }) => {
	...
	return import_react.createElement("div", {
		...
		let h = d.position || t, S = Ee(h, p.calculateOffset(d, {
			reverseOrder: e,
			gutter: s,
			defaultPosition: t
		}));
		return import_react.createElement(ve, {
			...
			style: S
		}, d.type === "custom" ? f(d.message, d) : a ? a(d) : import_react.createElement(C, {
			toast: d,
			position: h
		}));
	}));
...
var Vt = c;
//#endregion
export { _ as CheckmarkIcon, k as ErrorIcon, V as LoaderIcon, C as ToastBar, M as ToastIcon, Oe as Toaster, Vt as default, f as resolveValue, c as toast, O as useToaster, D as useToasterStore };
