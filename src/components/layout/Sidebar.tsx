...
import { 
  ...
  Bell, FileText, Settings, HelpCircle, PlusSquare, 
...
export const Sidebar: React.FC = () => {
  ...
  const entrepreneurItems = [
    ...
    { to: '/dashboard/create-project', icon: <PlusSquare size={20} />, text: 'Post a Project' },
...
// import { 
//   Home, Building2, CircleDollarSign, Users, MessageCircle, 
//   Bell, FileText, Settings, HelpCircle, PlusSquare // Add PlusSquare here
// } from 'lucide-react';
